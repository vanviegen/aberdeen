...
export const resetCounts = function() { newCount = changeCount = 0; };
export const getCounts = function() { return {new: newCount, change: changeCount}; };
...
export const setTimeout = function(func,time) {
	timeouts.push({func, time: time+currentTime});
};

export const passTime = function(ms) {
	let count = 0
...
export const asyncPassTime = async function(ms) {
	while(true) {
